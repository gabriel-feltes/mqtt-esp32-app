...
> [!NOTE]
> Este tutorial configura um broker MQTT privado na nuvem, com autenticação via aplicativo estático na pasta [`GPIO2_remote_control`](GPIO2_remote_control). Desenvolvido e testado no **Ubuntu 22.04 LTS**, adaptações podem ser necessárias para outros sistemas operacionais.
